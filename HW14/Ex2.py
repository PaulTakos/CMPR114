...
class TestAvg:
    def __init__(self):
        ...
        self.result2_label = tkinter.Label(self.sum_frame,
                                       text='Sum:')
        ...
        self.calc_button = tkinter.Button(self.button_frame,
                                          text='Calculate', command=self.calc_totals)
    ...
    def calc_totals(self):
        ...
        self.test_sum = self.test1 + self.test2 + \
            self.test3 + self.test4 + self.test5

        # Calculate the average.
        self.average = self.test_sum / 5.0
        ...
        self.sum.set(str(self.test_sum))
